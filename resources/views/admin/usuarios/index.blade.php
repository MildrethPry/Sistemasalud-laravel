                        ...
                        <tr>
                            ...
                            <td style="text-align:center ">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="{{url('admin/usuarios/'.$usuario->id)}}"  class="btn btn-info"><i class="bi bi-eye"></i></a>
                                    <a href="{{url('admin/usuarios/'.$usuario->id.'/edit')}}" type="button" class="btn btn-success"><i class="bi bi-pencil-square"></i></a>
                                    <a href="{{url('admin/usuarios/'.$usuario->id.'/confirm-delete')}}" type="button" class="btn btn-danger"><i class="bi bi-trash3"></i></a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
                    ...
                    $(function () {
                        $("#example1").DataTable({
                            ...
                            "language": {
                                ...
                                "infoFiltered": "(Filtrado de_MAX_total Usuarios)",
                                "infoPostFix": "",
                                "thousands": ",",
