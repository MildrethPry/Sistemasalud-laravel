...
class SecretariaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $secretaria->fecha_nacimiento = $request->fecha_nacimiento ?? null;
        $secretaria->direccion = $request->direccion;
        $secretaria->save();


        return redirect()->route('admin.secretarias.index')
            ->with('mensaje','La secretaria ha sido creada con exito')
            ->with('icono','success');
...
//
//        return redirect()->route('admin.secretarias.index')
//            ->with('mensaje','La actualizo a secretaria de ha sido creada con exito')
//            ->with('icono','success');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.secretarias.index')
            ->with('mensaje','La secretaria ha sido borrada con exito')
            ->with('icono','success');
